...
cases <- data.table::setDT(covidregionaldata::get_regional_data(country = "Canada"))
...
regional_epinow_with_settings(reported_cases = cases,
                ...
                no_cores = no_cores,
                target_dir = "subnational/canada/cases/national",
                summary_dir = "subnational/canada/cases/summary")
