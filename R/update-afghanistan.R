...
check_for_update(cases, last_run = here::here("last-update", "afghanistan.rds"))
...
regional_epinow_with_settings(reported_cases = cases,
                ...
                no_cores = no_cores,
                target_dir = "subnational/afghanistan/cases/national",
                summary_dir = "subnational/afghanistan/cases/summary")
